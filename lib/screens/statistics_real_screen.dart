...
class StatisticsRealScreen extends StatelessWidget {
  final StatisticsType type;
  final String title;
  final List<StatistikItem> data;

  const StatisticsRealScreen({
    super.key,
    required this.type,
    required this.title,
    required this.data,
  ...
  factory StatisticsRealScreen.santri(List<StatistikItem> santriData) {
    return StatisticsRealScreen(
  ...
  factory StatisticsRealScreen.sdm(List<StatistikItem> sdmData) {
    return StatisticsRealScreen(
  ...
  factory StatisticsRealScreen.alumni(List<StatistikItem> alumniData) {
    return StatisticsRealScreen(
